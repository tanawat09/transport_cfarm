                ...
                <tr>
                    <td>
                        <input
                            ...
                            value="{{ $vehicle->id }}"
                            form="bulk-qr-form"
                            data-supports-inspection="{{ $vehicle->supportsPreTripInspectionQr() ? '1' : '0' }}"
                            data-supports-usage="{{ (! $vehicle->supportsTractorUsageInspectionQr() && $vehicle->supportsUsageLog()) ? '1' : '0' }}"
                            data-supports-tractor-usage-inspection="{{ $vehicle->supportsTractorUsageInspectionQr() ? '1' : '0' }}"

...
<head>
    ...
    <title>พิมพ์สติ๊กเกอร์ QR ตรวจรถ {{ $vehicle->registration_number }}</title>
    <style>
            ...
            <header class="label-header">
                <div class="brand">
                    ...
                    <div>
                        ...
                        <div class="brand-subtitle">สติ๊กเกอร์ QR ตรวจรถก่อนวิ่ง</div>
                    </div>
                </div>
                <div class="header-chip">พิมพ์ 1 ดวง</div>
            </header>

            <div class="label-body">
                <div class="hero">
                    <div class="eyebrow">สแกนเพื่อเปิดฟอร์มตรวจรถ</div>
                ...
                <div class="content-grid">
                    ...
                    <div class="panel qr-panel">
                        ...
                        <div class="cta">สแกนเพื่อตรวจรถ</div>
                        <div class="hint">กรอก PIN ก่อนเริ่มบันทึกข้อมูลทุกครั้ง</div>
                    </div>
                </div>

                <div class="footer-note">
                    ป้ายนี้เหมาะสำหรับพิมพ์เดี่ยว 1 คันต่อ 1 หน้า ส่วนการพิมพ์หลายคันจะใช้หน้าสติ๊กเกอร์ 4 ดวงต่อ A4
                </div>
            </div>
        </section>
    </div>

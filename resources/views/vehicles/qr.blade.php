...
<div class="row justify-content-center">
    <div class="col-xl-8 col-lg-9">
        <div class="card border-0 shadow-sm overflow-hidden">
            <div class="card-header border-0 py-4 px-4 px-lg-5 text-white" style="background: linear-gradient(135deg, #17324d 0%, #1f5f66 100%);">
                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('images/cfarm-logo.png') }}" alt="CFARM" style="width: 120px; max-width: 100%; height: auto;">
                        <div>
                            <div class="fw-bold fs-4">QR ตรวจรถก่อนวิ่ง</div>
                            <div class="text-white-50">ระบบบริหารรถขนส่งอาหารไก่</div>
                        </div>
                    </div>
                    <span class="badge rounded-pill text-bg-light px-3 py-2 text-dark">สแกนเพื่อเปิดฟอร์มตรวจรถ</span>
                </div>
            </div>
                ...
                <div class="row g-4 align-items-stretch">
                    <div class="col-lg-5">
                        <div class="h-100 border rounded-4 bg-light-subtle p-4">
                            <div class="small text-success fw-semibold mb-2">ข้อมูลรถ</div>
                    ...
                    <div class="col-lg-7">
                        <div class="h-100 border rounded-4 p-4 text-center bg-white">
                            ...
                            <h3 class="fw-bold mb-2">สแกนเพื่อตรวจรถคันนี้</h3>
                            <p class="text-secondary mb-4">พนักงานสามารถสแกน QR แล้วกรอก PIN เพื่อเข้าสู่แบบฟอร์มตรวจรถก่อนวิ่งได้ทันที</p>

                            <div class="d-flex justify-content-center gap-2 flex-wrap">
                                <a href="{{ $qrToken->publicUrl() }}" class="btn btn-primary px-4" target="_blank">เปิดฟอร์มตรวจรถ</a>
                                <a href="{{ route('vehicles.inspection-qr-print', $vehicle) }}" class="btn btn-outline-secondary px-4" target="_blank">พิมพ์ QR</a>

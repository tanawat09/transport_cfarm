...
<head>
    ...
    <title>พิมพ์สติ๊กเกอร์ QR ใช้รถ {{ $vehicle->registration_number }}</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .label-header {
            ...
            gap: 16px;
            padding: 18px 24px;
            background: linear-gradient(135deg, #17324d 0%, #177b66 100%);
            color: #ffffff;
        }
        .brand {
            display: flex;
    ...
    <div class="sheet">
        <section class="label">
            <header class="label-header">
                <div class="brand">
                    ...
                    <div>
                        ...
                        <div class="brand-subtitle">สติ๊กเกอร์ QR บันทึกการใช้รถ</div>
                    </div>
                </div>
            ...
            <div class="label-body">
                <div class="hero">
                    <div class="eyebrow">สแกนเพื่อบันทึกการใช้รถ</div>
                ...
                <div class="content-grid">
                    ...
                    <div class="panel qr-panel">
                        ...
                        <div class="cta">สแกนเพื่อใช้รถ</div>
